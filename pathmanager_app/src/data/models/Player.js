...
export default class Player extends Character{
    ...
    getCreationVector(){
        return [this.name, this.description, this.level, this.xp, this.perception, this.unarmoredArmor,
            this.lightArmor, this.mediumArmor, this.heavyArmor, this.classDC, this.spellDC, this.health,
            this.fort, this.reflex, this.will, this.naturalAttack, this.simpleAttack, this.martialAttack,
            ...
            this.money, this.portrait, this.raceId, this.heritageId, this.sizeId, this.alignmentId, this.classId,
            this.deityId, this.dragonId
        ];
    }
};