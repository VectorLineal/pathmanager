...
import AttacksSelector from "./AttacksSelector.vue";
import SpellsSelector from "./SpellsSelector.vue";
import SpecialAbilitySelector from "./SpecialAbilitySelector.vue";
